...
export default class HrJobOfferFormWebPart extends BaseClientSideWebPart<IHrJobOfferFormWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IHrJobOfferFormProps> = React.createElement(
      HrJobOfferForm,
      {
